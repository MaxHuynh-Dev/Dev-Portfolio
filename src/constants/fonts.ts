...
export const nippo = localFont({
  ...
  display: 'swap',
  src: [
    { path: '../../public/fonts/nippo-400.woff2', weight: '400', style: 'normal' },
    { path: '../../public/fonts/nippo-500.woff2', weight: '500', style: 'normal' },
    { path: '../../public/fonts/nippo-700.woff2', weight: '700', style: 'normal' }
  ]
});
